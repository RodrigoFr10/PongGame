...
<body>
    ...
    $likeStmt = $conn->prepare($commentLikeSql);
    $likeStmt->bind_param("i", $comment["id"]);
    $likeStmt->execute();

    $commentLikes = $likeStmt->get_result()->fetch_assoc()["total"];
    ...
    $dislikeStmt = $conn->prepare($dislikeSql);
    $dislikeStmt->bind_param("i", $comment["id"]);
    $dislikeStmt->execute();

    $commentDislikes = $dislikeStmt->get_result()->fetch_assoc()["total"];
                    ...
                    <div class="comment">
                        ...
                        <div class="userTxtArea">
                            ...
                            <div class="likeDislikeArea">
                                ...
                                <form action="react_comment.php" method="post" style="display:inline;">
                                    <input type="hidden" name="comment_id" value="<?= $comment["id"] ?>">
                                    <input type="hidden" name="reaction" value="like">

                                    <button class="likeDislikeInput" type="submit">
                                        <i class="fa-regular fa-thumbs-up"><p class="numLikes"><?= $commentLikes ?></p></i> 
                                    </button>
                                </form>
                                ...
                                <form action="react_comment.php" method="post" style="display:inline;">
                                    ...
                                    <button class="likeDislikeInput" type="submit">
                                        <i class="fa-regular fa-thumbs-down"><p class="numLikes"><?= $commentDislikes ?></p></i> 
                                    </button>
                                </form>
                            </div>
                        </div>
